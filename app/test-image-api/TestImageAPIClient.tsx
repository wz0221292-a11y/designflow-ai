...
export default function TestImageAPIClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* 输入区域 */}
        <div className="bg-[#0f172a] rounded-xl shadow-sm p-6 mb-6">
          ...
          <textarea
            ...
            className="w-full h-24 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#818cf8] focus:border-transparent outline-none resize-none text-gray-900"
          ...
          <div className="mt-4 flex gap-3">
            <button
              onClick={runAllTests}
              disabled={testing}
              className="px-6 py-2 bg-[#818cf8] hover:bg-[#818cf8] disabled:bg-gray-400 text-white font-medium rounded-lg transition-colors"
            >
              {testing ? '测试中...' : '运行所有测试'}
            </button>
            <button
        ...
        {/* 结果展示 */}
        {results.length > 0 && (
          <div className="bg-[#0f172a] rounded-xl shadow-sm p-6">
              ...
              {results.map((result, index) => (
                <div
                  ...
                  className={`p-4 rounded-lg border ${
                    result.success ? 'border-green-200 bg-green-50' : 'border-[#991b1b] bg-[#1f0f0f]'
                  }`}
                >
                  ...
                  {result.success && result.imageUrl && (
                    <div className="mt-3">
                      ...
                      <a
                        ...
                        className="text-sm text-[#818cf8] hover:underline mt-2 inline-block"
                      >
                        查看原图 →
                      </a>
                    </div>
        ...
        {/* 说明 */}
        <div className="mt-6 bg-[#0f1b3d] border border-[#1e3a5f] rounded-lg p-4">
