...
export default function ProjectPage() {
  ...
  const { state, fetchProject, refreshProjectSilent, mergeImagesSilent, generateStep, nextStep, updateProject, goToStep, localUpdate, saveCurrentStep, flushPendingSave } = useProject();
  ...
  // 生成状态由组件通过 onGeneratingChange 回调上报，并直接从 imageTaskStore 恢复（零延迟）
      ...
      case 5:
        return (
          <StoryboardStep
            ...
            productIntro={project.product_intro}
